...
const staticData = {
	navMain: [
		...
		{ title: "Account", url: "/account", icon: Settings, items: [ { title: "CRM Connection", url: "/account/crm-connection" }, { title: "Calendar Mapping", url: "/account/calendar-mapping" }, { title: "Source Mapping", url: "/account/source-mapping" }, { title: "Team Members", url: "/account/team-members" } ] },
	],
	navSecondary: [
