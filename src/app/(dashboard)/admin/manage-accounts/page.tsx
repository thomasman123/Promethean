					...
					{impersonatedUserId && (
						<Card className="bg-amber-50 border-amber-200">
							<CardHeader className="py-3">
								...
								<CardDescription>You are currently impersonating a user. All actions will be performed as that user.</CardDescription>
							</CardHeader>
							<CardContent className="pt-0">
								<Button variant="outline" size="sm" onClick={async () => { await stopImpersonation(); toast.success('Stopped impersonating'); }}>
									Stop impersonating
								</Button>
							</CardContent>
						</Card>
