...
export default function CRMConnectionPage() {
  ...
  const initiateGHLConnection = async () => {
    ...
    try {
      ...
      const scope = 'locations.readonly calendars.readonly calendars/events.readonly contacts.readonly users.readonly conversations.readonly conversations/message.readonly'
