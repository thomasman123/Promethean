    ...
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <div className="pl-20 pr-8 pt-20 pb-8">
        ...
        <div className="flex justify-end gap-3 mb-6">
          {/* Date Picker Button */}
          <button className="flex items-center gap-2 px-4 py-2 bg-zinc-100 dark:bg-zinc-900 rounded-full text-sm font-medium text-zinc-900 dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-colors">
