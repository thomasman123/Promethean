    ...
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <div className="pl-20 pr-8 pt-20 pb-8">
        ...
        <div className="flex justify-end gap-3 mb-6">
          {/* Date Picker Button */}
          <button className="flex items-center gap-2 px-4 py-2 bg-zinc-100 dark:bg-zinc-800 rounded-full text-sm font-medium text-zinc-900 dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors">
        ...
        {/* Empty State */}
        {widgets.length === 0 && (
          <div className="flex items-center justify-center h-64 bg-zinc-100 dark:bg-zinc-800 rounded-2xl border-2 border-dashed border-zinc-300 dark:border-zinc-600">
